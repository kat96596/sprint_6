...
class TestOrderCreation:
    ...
    def test_create_order_positive(self, driver, order_data, entry_point):
        ...
        assert order_page.is_success_modal_displayed(), "Заказ не был успешно создан"
...
class TestNavigation:
    ...
    def test_scooter_logo_redirect(self, driver):
        ...
        main_page.click_order_button_header()
        order_page = OrderPage(driver)
        order_page.wait_for_element_visible(order_page.locators.NAME_INPUT)
